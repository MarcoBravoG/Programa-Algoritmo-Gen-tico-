function resp = f_resultado(x,pedido,componentes)
...
for m=1:rangoPedido(1,1)
    ...
    rT(n)=rA+rB+rC+rD+rE+rF+rG+rH+rI;
    n=n+1;
end
m_resultado(:,componentes+2)=rT(:);
resp = m_resultado;